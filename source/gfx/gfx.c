...
{
	// Software rotation (like TegraExplorer)
	*x = 1279 - gfx_con.y;  // YLEFT - y
	*y = gfx_con.x;
}

void gfx_con_setpos(u32 x, u32 y)
{
	// Software rotation for landscape mode (like TegraExplorer)
	gfx_con.x = y;
	gfx_con.y = 1279 - x;  // YLEFT = 1279
}
